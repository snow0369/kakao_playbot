...
def parse_weapon_hierarchy_from_html(html: str) -> Tuple[List[WeaponInfo], Dict[int, WeaponInfo]]:
    """
...
def crawl_all_hierarchies_by_clicking(
    ...
    for idx in range(total_tiles):
        ...
        # Parse hierarchy
        ordered_nodes, by_level = parse_weapon_hierarchy_from_html(html)
