...
def refresh_chat_window_safe(chat_text_xy, room_xy, input_xy,
                             bot_sender_name,
                             stop_flag: StopFlag,
    ...
    for attempt in range(1, max_tries + 1):
        ...
        # 5) 검증
        if verify_room_opened(chat_text_xy, bot_sender_name, stop_flag):
            return  # 성공
...
def verify_room_opened(chat_text_xy, bot_sender_name: str, stop_flag: StopFlag,
    ...
    full = select_all_copy_verified(chat_text_xy, stop_flag, retries=3)
